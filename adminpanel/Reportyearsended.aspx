<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Reportyearsended.aspx.cs" Inherits="adminpanel_Reportyearsended" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td class="auto-style21"></td>
            <td class="auto-style22">Hesabat ili:</td>
            <td class="auto-style23">
                <asp:DropDownList ID="ddlil" runat="server" Width="200px">
                </asp:DropDownList>
            </td>
            <td class="auto-style24"></td>
            <td class="auto-style24"></td>
    ...
    <div align="center">
        <table border="1" cellpadding="0" cellspacing="0" class="auto-style3" style="mso-yfti-tbllook: 1184; mso-padding-alt: 0in 5.4pt 0in 5.4pt">
            <tr>
                ...
                <td>
                    <p align="center" class="MsoNormal" style="margin-bottom: 0in; margin-bottom: .0001pt; text-align: center; line-height: normal">
                        <b><span>Yığımın yoxlanması</span></b>
                    </p>
                </td>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="auto-style16">
                            <span><%#Eval("IncomeID")%></span>
                        </td>
                        <td>
                            <span><%#Eval("FundID")%></span>
                        </td>
                        <td style="text-align:center">
                            <span><%#Eval("incomesehv")%></span>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
