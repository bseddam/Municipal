<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Ferqxerc.aspx.cs" Inherits="adminpanel_Ferqxerc" %>
    ...
    <div id="pnlhtml" runat="server" style="background-color: ActiveBorder; height: 500px; width: 100%; text-align: center; vertical-align: auto;">
        ...
        <div style="height: auto; width: 100%; background-color: white;">
            ...
            <asp:GridView ID="GridView1" Width="100%" CellPadding="4"
                AutoGenerateColumns="False" DataKeyNames="Name,MunicipalName,lblumumixerc,mebleg,ferq"
                runat="server">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Ümumi xərc" HeaderStyle-CssClass="headertextaligncenter"  DataField="lblumumixerc" />
                    <asp:BoundField HeaderText="Təsnifat üzrə xərc" HeaderStyle-CssClass="headertextaligncenter" DataField="mebleg" />
