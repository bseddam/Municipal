    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="style1" style="margin-top: 5px;">
                ...
                <tr>
                    <td style="text-align: center; background-color: Background; font-family: 'Times New Roman'; font-style: initial; color: white; font-size: 25px;" class="auto-style4">Bələdiyyələrin Avtomatlaşdırılmış Məlumat Sistemi
                    </td>
                </tr>
                                <tr>
                                ...
                                <td class="auto-style2">
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 30px; font-size: 17px;"><a href="Users/Regster.aspx" style="color: #000099">Qeydiyyat</a></td>
                                            <td style="padding-left: 30px; font-size: 17px;"><a href="Files\Telimat.pdf" target="_blank" style="color: #000099">Təlimat</a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
