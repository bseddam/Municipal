...
<%--    <div align="center">
    ...
    <table class="auto-style3x">
        ...
        <tr>
                ...
                <td class="auto-style14">
                    <asp:RadioButton ID="RadioButton1" runat="server" Text="Rayon"/>
                    <asp:RadioButton ID="RadioButton2" runat="server" Text="Bələdiyyə" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
...
yerliozunuidetme,tehsilsahesi,sehiyye,medeniyyet,idman,avtomobil,menzilkomunal,suteserrufati,iqtisadisahe,yerliekoloji,yerlisosialmud,digerxerc"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="2017-ci ildə vergi və ödənişlərdən daxil olma" HeaderStyle-CssClass="headertextaligncenter" DataField="gelir" />
