<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Calctodayadmin.aspx.cs" Inherits="adminpanel_PaymentNoticeadmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <tr>
                ...
                <td class="auto-style14">
                <asp:Button ID="btntediyye" runat="server" Text="Bu il üçün hesabla" Width="218px" OnClick="btntediyye_Click" />
                </td>
                <td>
