...
public partial class Users_Homepagegjv : System.Web.UI.Page
{
    ...
    protected void selectpeymants()
    {
        ...
        string MunicipalId = " "; string ray = " "; string odeniw = " ";
        ...
        {
            MunicipalId = " and vpb.MunicipalID=" + ddlbelediyye.SelectedValue;
        }
 ...
 inner join List_classification_Municipal lcm on vpb.MunicipalID=lcm.MunicipalID where 1=1 " + MunicipalId + ray+ odeniw +
" union  select '1' sn, fullname,YVOK,nametype,id,cast(Mebleg as numeric(15,2)) Mebleg,Tarix from ViewPaymentBaza vpb " +
" inner join List_classification_Municipal lcm on vpb.MunicipalID=lcm.MunicipalID where 1=1 " + MunicipalId + ray+ odeniw +" order by sn,fullname");
