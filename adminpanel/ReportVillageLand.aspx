<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ReportVillageLand.aspx.cs" Inherits="Users_Homepageabb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <div id="pnlhtml" runat="server"  style="background-color:ActiveBorder; height:500px; width:100%; text-align:center; vertical-align:auto;">
     ...
     <h3>Kənd təsərrüfatı təyinatlı torpaq sahələri üzrə</h3> </div>

     <div style="height:auto; width:100%; background-color:white;">
             <asp:GridView ID="GridView1" Width="100%" CellPadding="4"
                AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="Sn,fullname,YVOK,Name,Concession1,QualityGroup,ConditionalPoints,GeneralArea,mebleg,Tarix"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Keyfiyyət qrupu" HeaderStyle-CssClass="headertextaligncenter" DataField="QualityGroup" />
                      <asp:BoundField HeaderText="Şərti bal" HeaderStyle-CssClass="headertextaligncenter" DataField="ConditionalPoints" />
                     <asp:BoundField HeaderText="Torpaq sahəsi (ha)" HeaderStyle-CssClass="headertextaligncenter" DataField="GeneralArea" />
