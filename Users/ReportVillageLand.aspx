<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMasterPage.master" AutoEventWireup="true" CodeFile="ReportVillageLand.aspx.cs" Inherits="Users_Homepage232" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="pnlhtml" runat="server" style="background-color: ActiveBorder; height: 500px; width: 100%; text-align: center; vertical-align: auto;">
        ...
        <div style="padding-top: 10px; text-align: center;">
            <h3>Kənd təsərrüfatı təyinatlı torpaq sahələri üzrə</h3>
        </div>
